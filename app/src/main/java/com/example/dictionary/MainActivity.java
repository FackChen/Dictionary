...
//        showLog();
        ...
        //保存数据
//        Word getWord=new Word(load()[0],load()[1]);/*此法不通*/
...
//        editor.putStringSet("en",save_en);
//        editor.putStringSet("ch",save_ch);
        editor.putStringSet("save_data",save);
        editor.apply();
//        Log.d("顺序","onDestroy");
//        FileOutputStream out_en=null;
//        FileOutputStream out_ch=null;
//        BufferedWriter writer_en=null;
//        BufferedWriter writer_ch=null;
//        String en=newWord.getEnW().toString();
//        String ch=newWord.getChW().toString();
//        try{
//            out_en=openFileOutput("data_en", Context.MODE_PRIVATE);
//            out_ch=openFileOutput("data_ch", Context.MODE_PRIVATE);
//            writer_en=new BufferedWriter(new OutputStreamWriter(out_en));
//            writer_ch=new BufferedWriter(new OutputStreamWriter(out_ch));
//            writer_en.write(en);
//            writer_ch.write(ch);
//        }catch(IOException e){
//            e.printStackTrace();
...
//    public String[] load(){
//        FileInputStream in_en=null;
//        FileInputStream in_ch=null;
//        BufferedReader reader_en=null;
//        BufferedReader reader_ch=null;
//        StringBuilder content_en=new StringBuilder();
//        StringBuilder content_ch=new StringBuilder();
//        String[] content={content_en.toString(),content_ch.toString()};
//        try{
//            in_en=openFileInput("data_en");
//            in_ch=openFileInput("data_ch");
//            reader_en=new BufferedReader(new InputStreamReader(in_en));
//            reader_ch=new BufferedReader(new InputStreamReader(in_ch));
//            String line_en="";
//            String line_ch="";
//            while ((line_en=reader_en.readLine())!=null){
//                content_en.append(line_en);
//            }
//            while ((line_ch=reader_ch.readLine())!=null){
//                content_ch.append(line_ch);
//            }
//        }catch (IOException e){
//            e.printStackTrace();
//        }finally {
